...
contract ERC20Token is BasicToken, ERC20 {
	...
	function approve(address _spender, uint256 _value) public returns (bool) {
		require(_value == 0 || allowed[msg.sender][_spender] == 0, "ERC20 : Check if the amount is 0 or the allowed amount is 0");
...
contract INVIToken is DetailedERC20, ERC20Token,Pausable{
	using SafeMath for uint256;
	...
	string public constant symbol = "INVI";
 	string public constant name = "INVI Token";
